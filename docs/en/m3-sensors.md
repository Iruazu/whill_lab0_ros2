...
Language: [日本語](../ja/m3-sensors.md) | [English](m3-sensors.md)
...
| Per-sensor rosbag captured on the chair | done (2026-05-07) — `m3_chair_static_2026-05-07/` (1.1 GiB, 19.85 s, stationary; 0/99 motion bursts) and `m3_chair_motion_2026-05-07/` (5.3 GiB, 96.85 s; 5 s static warm-up + hallway and chair/desk room drive with attempted loop closure; first 5 s also verified 0/25 motion bursts). Both gitignored. See [`m3-bench-data/README.md`](../m3-bench-data/README.md) for verification methodology and the IMU race-condition fix that turned up during the chair bringup. |
